...
public class ReservaController {
    ...
    public static double reservarQuarto(QuartoDTO quarto, String cpf, Date checkin, Date checkout) {
        ...
        Reserva reservaEntity = builder.builder(); 
        new ReservaDAO().cadastrarReserva(reservaEntity); 
    ...
    public static List<Reserva> resgatarReservasDeClientes(String cpf) {
        List<Reserva> reservas = new ReservaDAO().listarReservasPorCliente(cpf);
    ...
    public static boolean consultarDisponibilidade(QuartoDTO quarto, Date dataCheckin, Date dataCheckout) {
        ...
        List<Reserva> reservas = reservaDAO.listarReservasPorQuarto(idQuarto);
